...
def create_AP_Summary_frame():
    ...
    # Sets title and labels of 'AP Summary File Upload' GUI
    ...
    def anaylze_AP_summary():
        ...
        # Defines plt figures and canvas'
        ...
        # data frame creation for bar graph
...
def create_AR_Summary_frame():
    ...
    # Creates lables/ textbox for 'AR Summary Frame' GUI and sets location on GUI
...
def create_assets_liabilities_Summary_frame():
    ...
    # method for ETL of .xlsx data for bar/graphs
    def analyze_AL_summary():
        ...
        # creates total liabilities bar graph figure and canvas
        ...
        # technique for saving image as pdf
        def save_data():
        ...
        # Buttons for Assets Liabilities and position
...
def create_Revenue_Expenses_frame():
    ...
    # Method for ETL of Revenue and Expneses .xlsx file
    def analyze_revenue_expenses():
        ...
        # Creates and sets figures/canvas
...
def create_Revenue_Expenses_Comparison_frame():
    ...
    def analyze_revenue_expenses_comparision():
        ...
        # Button for Revenue and Expenses Compared to Prev Year and positions
...
def create_Revenue_Expenses_Budget_frame():
   ...
   # Hides 'Main Screen' GUI
    ...
    # Method for ETL of Revenue and Expenses Budget
    def analyze_revenue_expneses_budget():
        ...
        # Button for Revenue and Expenses Compared to Budget and positions
...
def create_Revenue_Expenses_Program_frame():
    ...
    def analyze_revenue_expenses_program():
        ...
        # Buttons Revenues and Expenses Compared to Program and positions
